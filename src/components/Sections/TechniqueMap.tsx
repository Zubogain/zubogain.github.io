...
//           <picture>
//             <source
//               srcSet="/static//static/img/main/map-background.webp"
//               type="image/webp"
//             />
//             <img src="/static//static/img/main/map-background.png" alt="Карта" />
//           </picture>
//         </div>
                  ...
                  <div className="map__info-content info-content">
                    ...
                    <div className="info-content__wrapper">
                      <div className="info-content__image">
                        <picture>
                          <source
                            srcSet="img/catalog/catalog_img-01.webp"
                            type="image/webp"
                          />
                          <img
                            className="info-content__img"
                            src="img/catalog/catalog_img-01.png"
                            alt=""
                          />
                        </picture>
                      </div>
