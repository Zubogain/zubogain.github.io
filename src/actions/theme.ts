...
export const THEME_SET_HEADER_TRANSPARENT =
  "THEME_SET_HEADER_TRANSPARENT"
  ;
export const THEME_SET_CURRENT_RESOLUTION =
...
export const THEME_SET_SIDE_NOTIFICATIONS_HIDE = "THEME_SET_SIDE_NOTIFICATIONS_HIDE";
