 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            const headerMain = document.querySelector(".header__wrap");
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                } else if (!headerMain.contains(e.target)) functions_menuClose();
            }));
        }
        ...
        function menuInitCategory() {
            const categoryNav = document.querySelector(".category-header__nav");
            if (categoryNav) if (document.querySelector(".icon-close")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-close")) {
                    bodyUnlock();
                    document.documentElement.classList.toggle("menu-category");
                    document.documentElement.classList.remove("menu-open");
                } else if (!categoryNav.contains(e.target)) menuCloseC();
            }));
        }
        function menuCloseC() {
            bodyUnlock();
            document.documentElement.classList.remove("menu-category");
        }
        ...
        document.addEventListener("click", (e => {
            ...
            if (authButtonRow) authButtonRow.style.display = "none";
            ...
            function isTelValid(currentNumber) {
                if (currentNumber.match(/^\+40/)) return currentNumber.match(/^\+40 [0-9]{3} [0-9]{3} [0-9]{3}$/); else if (currentNumber.match(/^\+90/)) return currentNumber.match(/^\+90 [0-9]{3} [0-9]{3} [0-9]{4}$/); else if (currentNumber.match(/^\+37 3/)) return currentNumber.match(/^\+37 3[0-9]{2} [0-9]{3} [0-9]{4}$/); else if (currentNumber.match(/^\+38 0/)) return currentNumber.match(/^\+38 0[0-9]{2} [0-9]{3} [0-9]{4}$/); else return false;
            }
            function startTimer() {
                const timeoutTime = 119e3 + Date.now();
                timer = setInterval((() => {
            ...
            return i = o, (a = [ {
                ...
                value: function(e) {
                    ...
                    if (0 !== t.length) if (t = t.filter((function(e) {
                        ...
                        e.shiftKey && 0 === o && (t[t.length - 1].focus(), e.preventDefault()), !e.shiftKey && t.length > 0 && o === t.length - 1 && (t[0].focus(), 
                        e.preventDefault());
                    } else t[0].focus();
                }
        ...
        if (addWrapper) {
            ...
            function getListValue(item) {
                ...
                options.forEach((option => {
                    if (option.dataset.value == selectedItemId) result = option.textContent;
                }));
                return result || "-";
            }
            function getResults() {
        ...
        if (orderButton) orderButton.addEventListener("click", (e => {
            ...
            if (false == orderCategoryId) {
                e.preventDefault();
                e.stopPropagation();
                orderCategoryButton.style.border = "1px solid #e74c3c";
                orderCategoryButton.style.backgroundColor = "#ffa69c";
                errorMessage.classList.add("error-message");
            } else {
                orderCategoryButton.style.border = "1px solid #A2A2A2";
                orderCategoryButton.style.backgroundColor = "#292929";
                errorMessage.classList.remove("error-message");
            }
            if (false == orderLocationId) {
                e.preventDefault();
                e.stopPropagation();
                orderLocationButton.style.border = "1px solid #e74c3c";
                orderLocationButton.style.backgroundColor = "#ffa69c";
                errorMessage.classList.add("error-message");
            } else {
                orderLocationButton.style.border = "1px solid #A2A2A2";
                orderLocationButton.style.backgroundColor = "#292929";
                errorMessage.classList.remove("error-message");
            }
            if ("block" !== successMessage.style.display) {
                e.preventDefault();
                e.stopPropagation();
                errorMessage.classList.add("error-message");
            } else errorMessage.classList.remove("error-message");
        }));
        const useFilter = () => {
            ...
            if (sidebar) {
                ...
                filterResetLocal.forEach((item => {
                    ...
                    if (0 === selectedItems.length) item.classList.add("hidden");
                }));
                ...
                function renderList() {
                    ...
                    filterResetLocal.forEach((item => {
                        0 === selectedItems.length ? item.classList.add("hidden") : item.classList.remove("hidden");
                    }));
                }
            }
        };
        const useTranslate = () => {
            ...
            changeLangTrigers.forEach((item => {
                item.addEventListener("change", (() => {
                    if (item.checked) changeLang(item);
                }));
            }));
            ...
            async function getTranlsate(translateLang) {
                try {
                    ...
                    elementsToTranslate.forEach((element => {
                        ...
                        if ("INPUT" === element.tagName || "TEXTAREA" === element.tagName) element.placeholder = translation; else element.textContent = translation;
                    }));
                } catch (error) {
                    console.log(error);
                }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            var maskOptions = {
                ...
                oncomplete: function() {
                    ...
                    var isValid = false;
                    if (inputValue.match(/^\+40/)) isValid = inputValue.match(/^\+40 [0-9]{3} [0-9]{3} [0-9]{3}$/); else if (inputValue.match(/^\+90/)) isValid = inputValue.match(/^\+90 [0-9]{3} [0-9]{3} [0-9]{4}$/); else if (inputValue.match(/^\+37 3/)) isValid = inputValue.match(/^\+37 3[0-9]{2} [0-9]{3} [0-9]{4}$/); else if (inputValue.match(/^\+38 0/)) isValid = inputValue.match(/^\+38 0[0-9]{2} [0-9]{3} [0-9]{4}$/);
                    if (!isValid) {
                        ...
                        if (this.dataset.error) this.parentElement.insertAdjacentHTML("beforebegin", `<div class="form__error">${this.dataset.error}</div>`);
                        this.value = "";
                    }
                }
            };
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                const mySwiper = new core(".category-popup__slider", {
        ...
        if (wrapper) document.addEventListener("DOMContentLoaded", (() => {
            wrapper.addEventListener("click", (() => {
                ...
                loader.load().then((() => {
                    ...
                    var markersLoc = [ [ "Mumbai", 48.2437167, 19.3394151 ], [ "Pune", 48.2463182, 17.659755 ], [ "Bhopal ", 47.0842848, 3.1437127 ], [ "Agra", 50.4268, 30.5632 ], [ "Delhi", 50.9684777, 58.38623459999999 ] ];
                    ...
                    var infoWindowContent = [ [ '<div class="info-content">' + '<div class="info-content__wrapp">' + '<div class="info-content__body-title">' + '<div class="info-content__body-title">' + infoTitle[0].innerHTML + "</div>" + '<div class="info-content__title-text">' + infoTitleText[0].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__wrapper">' + '<div class="info-content__image">' + '<img class="info-content__img" src="' + infoImg[0].src + '" alt="">' + "</div>" + '<div class="info-content__main">' + '<div class="info-content__header">' + '<div class="info-content__row">' + '<div class="info-content__name-type">' + infoName[0].innerHTML + "</div>" + '<div class="info-content__descr-type">' + infoType[0].innerHTML + "</div>" + "</div>" + '<div class="info-content__row">' + '<div class="info-content__name-brand">' + infoBrand[0].innerHTML + "</div>" + '<div class="info-content__descr-brand">' + infoDescrBrand[0].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__footer">' + '<div class="info-content__text info-content__text-1">' + infoText1[0].innerHTML + "</div>" + '<div class="info-content__text info-content__text-2">' + infoText2[0].innerHTML + "</div>" + '<div class="info-content__text info-content__text-3">' + infoText3[0].innerHTML + "</div>" + '<div class="info-content__text info-content__text-4">' + infoText4[0].innerHTML + "</div>" + "</div>" + "</div>" + "</div>" + '<div class="info-content__price">' + '<button type="submit" class="info-content__button-price info-content__button-hour btn">' + infoHour[0].innerHTML + "</button>" + '<button type="submit" class="info-content__button-price info-content__button-day btn">' + infoDay[0].innerHTML + "</button>" + '<a href="' + infoOrder[0].href + '" target="_blank" class="info-content__button-price info-content__button-order btn btn-c" data-translate="GET_ORDER_BUTTON">' + infoBtnOrder[0].innerHTML + "</a>" + "</div>" + "</div>" ], [ '<div class="info-content">' + '<div class="info-content__wrapp">' + '<div class="info-content__body-title">' + '<div class="info-content__body-title">' + infoTitle[1].innerHTML + "</div>" + '<div class="info-content__title-text">' + infoTitleText[1].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__wrapper">' + '<div class="info-content__image">' + '<img class="info-content__img" src="' + infoImg[1].src + '" alt="">' + "</div>" + '<div class="info-content__main">' + '<div class="info-content__header">' + '<div class="info-content__row">' + '<div class="info-content__name-type">' + infoName[1].innerHTML + "</div>" + '<div class="info-content__descr-type">' + infoType[1].innerHTML + "</div>" + "</div>" + '<div class="info-content__row">' + '<div class="info-content__name-brand">' + infoBrand[1].innerHTML + "</div>" + '<div class="info-content__descr-brand">' + infoDescrBrand[1].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__footer">' + '<div class="info-content__text info-content__text-1">' + infoText1[1].innerHTML + "</div>" + '<div class="info-content__text info-content__text-2">' + infoText2[1].innerHTML + "</div>" + '<div class="info-content__text info-content__text-3">' + infoText3[1].innerHTML + "</div>" + '<div class="info-content__text info-content__text-4">' + infoText4[1].innerHTML + "</div>" + "</div>" + "</div>" + "</div>" + '<div class="info-content__price">' + '<button type="submit" class="info-content__button-price info-content__button-hour btn">' + infoHour[1].innerHTML + "</button>" + '<button type="submit" class="info-content__button-price info-content__button-day btn">' + infoDay[1].innerHTML + "</button>" + '<a href="' + infoOrder[1].href + '" target="_blank" class="info-content__button-price info-content__button-order btn btn-c" data-translate="GET_ORDER_BUTTON">' + infoBtnOrder[1].innerHTML + "</a>" + "</div>" + "</div>" ], [ '<div class="info-content">' + '<div class="info-content__wrapp">' + '<div class="info-content__body-title">' + '<div class="info-content__body-title">' + infoTitle[2].innerHTML + "</div>" + '<div class="info-content__title-text">' + infoTitleText[2].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__wrapper">' + '<div class="info-content__image">' + '<img class="info-content__img" src="' + infoImg[2].src + '" alt="">' + "</div>" + '<div class="info-content__main">' + '<div class="info-content__header">' + '<div class="info-content__row">' + '<div class="info-content__name-type">' + infoName[2].innerHTML + "</div>" + '<div class="info-content__descr-type">' + infoType[2].innerHTML + "</div>" + "</div>" + '<div class="info-content__row">' + '<div class="info-content__name-brand">' + infoBrand[2].innerHTML + "</div>" + '<div class="info-content__descr-brand">' + infoDescrBrand[2].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__footer">' + '<div class="info-content__text info-content__text-2">' + infoText1[2].innerHTML + "</div>" + '<div class="info-content__text info-content__text-2">' + infoText2[2].innerHTML + "</div>" + '<div class="info-content__text info-content__text-3">' + infoText3[2].innerHTML + "</div>" + '<div class="info-content__text info-content__text-4">' + infoText4[2].innerHTML + "</div>" + "</div>" + "</div>" + "</div>" + '<div class="info-content__price">' + '<button type="submit" class="info-content__button-price info-content__button-hour btn">' + infoHour[2].innerHTML + "</button>" + '<button type="submit" class="info-content__button-price info-content__button-day btn">' + infoDay[2].innerHTML + "</button>" + '<a href="' + infoOrder[2].href + '" target="_blank" class="info-content__button-price info-content__button-order btn btn-c" data-translate="GET_ORDER_BUTTON">' + infoBtnOrder[2].innerHTML + "</a>" + "</div>" + "</div>" ], [ '<div class="info-content">' + '<div class="info-content__wrapp">' + '<div class="info-content__body-title">' + '<div class="info-content__body-title">' + infoTitle[3].innerHTML + "</div>" + '<div class="info-content__title-text">' + infoTitleText[3].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__wrapper">' + '<div class="info-content__image">' + '<img class="info-content__img" src="' + infoImg[3].src + '" alt="">' + "</div>" + '<div class="info-content__main">' + '<div class="info-content__header">' + '<div class="info-content__row">' + '<div class="info-content__name-type">' + infoName[3].innerHTML + "</div>" + '<div class="info-content__descr-type">' + infoType[3].innerHTML + "</div>" + "</div>" + '<div class="info-content__row">' + '<div class="info-content__name-brand">' + infoBrand[3].innerHTML + "</div>" + '<div class="info-content__descr-brand">' + infoDescrBrand[3].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__footer">' + '<div class="info-content__text info-content__text-1">' + infoText1[3].innerHTML + "</div>" + '<div class="info-content__text info-content__text-2">' + infoText2[3].innerHTML + "</div>" + '<div class="info-content__text info-content__text-3">' + infoText3[3].innerHTML + "</div>" + '<div class="info-content__text info-content__text-4">' + infoText4[3].innerHTML + "</div>" + "</div>" + "</div>" + "</div>" + '<div class="info-content__price">' + '<button type="submit" class="info-content__button-price info-content__button-hour btn">' + infoHour[3].innerHTML + "</button>" + '<button type="submit" class="info-content__button-price info-content__button-day btn">' + infoDay[3].innerHTML + "</button>" + '<a href="' + infoOrder[3].href + '" target="_blank" class="info-content__button-price info-content__button-order btn btn-c" data-translate="GET_ORDER_BUTTON">' + infoBtnOrder[3].innerHTML + "</a>" + "</div>" + "</div>" ], [ '<div class="info-content">' + '<div class="info-content__wrapp">' + '<div class="info-content__body-title">' + '<div class="info-content__body-title">' + infoTitle[4].innerHTML + "</div>" + '<div class="info-content__title-text">' + infoTitleText[4].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__wrapper">' + '<div class="info-content__image">' + '<img class="info-content__img" src="' + infoImg[4].src + '" alt="">' + "</div>" + '<div class="info-content__main">' + '<div class="info-content__header">' + '<div class="info-content__row">' + '<div class="info-content__name-type">' + infoName[4].innerHTML + "</div>" + '<div class="info-content__descr-type">' + infoType[4].innerHTML + "</div>" + "</div>" + '<div class="info-content__row">' + '<div class="info-content__name-brand">' + infoBrand[4].innerHTML + "</div>" + '<div class="info-content__descr-brand">' + infoDescrBrand[4].innerHTML + "</div>" + "</div>" + "</div>" + '<div class="info-content__footer">' + '<div class="info-content__text info-content__text-1">' + infoText1[4].innerHTML + "</div>" + '<div class="info-content__text info-content__text-2">' + infoText2[4].innerHTML + "</div>" + '<div class="info-content__text info-content__text-3">' + infoText3[4].innerHTML + "</div>" + '<div class="info-content__text info-content__text-4">' + infoText4[4].innerHTML + "</div>" + "</div>" + "</div>" + "</div>" + '<div class="info-content__price">' + '<button type="submit" class="info-content__button-price info-content__button-hour btn">' + infoHour[4].innerHTML + "</button>" + '<button type="submit" class="info-content__button-price info-content__button-day btn">' + infoDay[4].innerHTML + "</button>" + '<a href="' + infoOrder[4].href + '" target="_blank" class="info-content__button-price info-content__button-order btn btn-c" data-translate="GET_ORDER_BUTTON">' + infoBtnOrder[4].innerHTML + "</a>" + "</div>" + "</div>" ] ];
        ...
        if (wrapperMap) document.addEventListener("DOMContentLoaded", (() => {
        ...
        if (window.matchMedia("(min-width: 768px)").matches) {
            ...
            loginHeaderItem.addEventListener("mouseout", (event => {
                if (!loginHeaderItem.contains(event.relatedTarget)) if (loginHeaderBody.classList.contains("visible")) {
                    headerTitleLogin.classList.remove("active");
                    loginHeaderBody.classList.remove("visible");
        ...
        document.querySelectorAll("[data-dropdown]").forEach((function(dropDownWrapper) {
            ...
            if (dropDownListItems) dropDownListItems.forEach((function(listItem) {
        ...
        if (!locationHeaderBody.classList.contains("hide")) locationHeaderTitle.addEventListener("mouseover", (function() {
        ...
        checkBox.onclick = function() {
            if (this.checked) document.body.classList.add("dark-theme"); else document.body.classList.remove("dark-theme");
        };
        ...
        if (cookieAlert) {
            ...
            let scrollHandler = function() {
                const screenPosition = 2 * window.innerHeight;
                if (window.pageYOffset > screenPosition) cookieAlert.classList.add("show");
            };
            if (!cookiesAccepted && !cookiesRefused) window.addEventListener("scroll", scrollHandler);
            ...
            if (cookiesAccepted || cookiesRefused) cookieAlert.classList.remove("show");
        }
        ...
        const observer = new MutationObserver(((mutationsList, observer) => {
            mutationsList.forEach((mutation => {
                if ("attributes" === mutation.type && "class" === mutation.attributeName && mutation.target.classList.contains("active") && mutation.target.classList.contains("_bg")) htmlEl.classList.add("_bg-body"); else if ("attributes" === mutation.type && "class" === mutation.attributeName && !mutation.target.classList.contains("active") && mutation.target.classList.contains("_bg")) {
                    const activeEls = document.querySelectorAll(".active._bg");
                    if (0 === activeEls.length) htmlEl.classList.remove("_bg-body");
                }
            }));
        }));
        const mediaQuery = window.matchMedia("(min-width: 768px)");
        const handleMediaQuery = mediaQuery => {
            if (mediaQuery.matches) bgEls.forEach((el => {
                observer.observe(el, {
                    attributes: true
                });
            })); else htmlEl.classList.remove("_bg-body");
        };
        ...
        const observerRoot = new MutationObserver(((mutationsList, observer) => {
            mutationsList.forEach((mutation => {
                if ("attributes" === mutation.type && "class" === mutation.attributeName && mutation.target.classList.contains("active") && mutation.target.classList.contains("lang-header__button")) rootEl.classList.add("_bg-body"); else if ("attributes" === mutation.type && "class" === mutation.attributeName && !mutation.target.classList.contains("active") && mutation.target.classList.contains("lang-header__button")) {
                    const activeEls = document.querySelectorAll(".active.lang-header__button");
                    if (0 === activeEls.length) rootEl.classList.remove("_bg-body");
                }
            }));
        }));
        const minWidthMediaQuery = window.matchMedia("(max-width: 768px)");
        const handleMinWidthMediaQuery = mediaQuery => {
            if (mediaQuery.matches) observerRoot.observe(langButton, {
                attributes: true
            }); else rootEl.classList.remove("_bg-body");
        };
        ...
        searchHeader.addEventListener("mouseout", (event => {
            ...
            if (!searchHeader.contains(event.relatedTarget)) searchList.innerHTML = "";
        }));
        ...
        if (marginRight < 0) marginRight = -marginRight;
        ...
        inputElements.forEach((inputElement => {
            inputElement.addEventListener("input", (() => {
                ...
                const maxLength = 4;
                if (numericValue.length > maxLength) inputElement.value = numericValue.slice(0, maxLength); else inputElement.value = numericValue;
            }));
        }));
        window["FLS"] = true;
        useFilter();
